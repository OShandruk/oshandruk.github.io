...
//@prepros-append jquery.lettering.min.js
...
//************************** LETTERING
$(document).ready(function() {
	    $(".offer__item-text, .offer__item-text-bottom").lettering();
	  });
...
$(document).ready(function() {
	    $('.menu__item-composition').hide();
		$('.menu__item').hover(function(){

			// $(".menu__item-composition").slideToggle(300)
...
$(document).ready(function(){
  ...
  // dotsClass:'slider__dotted',

  		// prev arrow
  		prevArrow:'<div class="arrow__left"><img src="img/reviews/left.png" alt=""></div>',
  		// next arrow
  		nextArrow:'<div class="arrow__right"><img src="img/reviews/right.png" alt=""></div>',
  });
});
// *************************************************
// END SLICK SLIDER
...
// **********************ORDER HOVER***************************
$(document).ready(function(){
    $(".order__hover-img").hover( function (event) {
        $(this).children().toggle(200);
    });
     $(".popup__row-img").hover( function (event) {
        $(this).children().toggle(200);
    });
    ...
    $('.smoll-button').click( function (event) {

        $('.order__hover').fadeOut();
    });

 

    $(document).mouseup(function (e){ // событие клика по веб-документу
		var div = $(".order__hover"); 
		var div2 = $(".order__hover-sum-btn");		// тут указываем ID элемента
