...
let menuArrows = document.querySelectorAll('.menu__arrow');
  ...
  // SWIPER Init
  var galleryThumbs = new Swiper('.counted-thumbs', {
    spaceBetween: 30,
    slidesPerView: 1,
    breakpoints: {
      479.98: {
  ...
  var galleryTop = new Swiper('.counted-slider-top', {
    spaceBetween: 1,
    navigation: {
      nextEl: '.counted-button-next',
      prevEl: '.counted-button-prev',
    },
    thumbs: {
  ...
  // OUR WORK SLIDER 
  var ourWork = new Swiper('.ourwork__slider', {
    spaceBetween: 1,
    loop: true,
    breakpoints: {
      991.98: {
        navigation: {
          nextEl: '.outwork-button-prev',
          prevEl: '.outwork-button-next',
        },
        pagination: {
